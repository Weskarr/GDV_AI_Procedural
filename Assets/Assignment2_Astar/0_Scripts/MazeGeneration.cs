...
public class MazeGeneration : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        MyInputHandler.OnSpaceStarted += SpaceRandomizer;
        Random.InitState(seed);
        GenerateMaze();
    }

    /* 
    // No longer needed, switched to new Input System!
    private void Update() { }
    */

    // Moved from update to own function
    private void SpaceRandomizer()
    {
